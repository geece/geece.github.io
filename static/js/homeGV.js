$(document).ready(function () {
    ...
    let bannerDeskLottie = lottie.loadAnimation({
    ...
    let bannerMobileLottie = lottie.loadAnimation({
    ...
    function stopAnimeD() {
        bannerDeskLottie.stop();
    }

    function pauseAnimeD() {
        bannerDeskLottie.pause();
    }

    function playAnimeD() {
        bannerDeskLottie.play();
    }

    function stopAnimeM() {
        bannerMobileLottie.stop();
    }

    function pauseAnimeM() {
        bannerMobileLottie.pause();
    }

    function playAnimeM() {
        bannerMobileLottie.play();
    }
